...
function likes(id) {
  ...
  document.getElementById(id).src == `https://re000s0.github.io/Morent/heart1.svg` ? document.getElementById(id).src = `./heart2.svg` : document.getElementById(id).src = `./heart1.svg`;
}
for (let i = 0; i < 12; i++) {
